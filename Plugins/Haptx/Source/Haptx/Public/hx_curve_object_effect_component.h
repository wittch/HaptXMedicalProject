...
#include "hx_curve_object_effect_component.generated.h"

//! An implementation of UHxObjectEffectComponent that defines the Haptic Effect using a provided
//! UCurveFloat.
//!
...
class HAPTX_API UHxCurveObjectEffectComponent : public UHxObjectEffectComponent {
  GENERATED_BODY()
