...
#include "hx_wave_object_effect_component.generated.h"

//! An implementation of UHxObjectEffectComponent that defines the Haptic Effect using a
//! simple sine wave generator. The waveform starts at 0 then increases by default.
//!
//! @ingroup group_unreal_plugin

// An implementation of UHxObjectEffectComponent that defines the Haptic Effect using a simple sine
...
class HAPTX_API UHxWaveObjectEffectComponent : public UHxObjectEffectComponent {
  GENERATED_BODY()
